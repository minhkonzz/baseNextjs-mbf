...
function InputGroup({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-md border border-zinc-200 shadow-xs transition-[color,box-shadow] outline-none dark:border-zinc-800 dark:bg-zinc-200/30 dark:dark:bg-zinc-800/30",
...
function InputGroupButton({
  ...
  size = "xs",
  ...props
}: Omit<ComponentProps<typeof MbfButton>, "size"> &
